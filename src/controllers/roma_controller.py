...
class ROMAMAC(BasicMAC):
    def __init__(self, scheme, groups, args):
        super(ROMAMAC, self).__init__(scheme, groups, args)
    ...
    def init_hidden(self, batch_size):
        if self.args.use_cuda:
            self.hidden_states = th.zeros(batch_size, self.n_agents, self.args.rnn_hidden_dim).to(self.args.device)  # (bs,n,hidden_dim)
        else:
